...
<nav id="nav" role="navigation">
	...
	<ul class="clearfix">
		<li>
			<a href="/?p=appcafe&jail=<? echo "$jailUrl"; ?>" aria-haspopup="true"><span><img src="/images/appcafe.png" height=48 width=48> AppCafe <? if ( $jail == "#system" ) { echo "(Local System)"; } elseif (! empty($jail) ) { echo "($jail)"; } else { echo "(No jail selected)"; } ?></span></a>
                        <ul>

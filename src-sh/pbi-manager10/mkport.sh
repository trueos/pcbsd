...
tar cvf - --exclude .svn INSTALL Makefile install.sh pbi-manager etc icons man1 man5 man8 module-examples rc.d repo wrapper 2>/dev/null| tar xvf - -C /tmp/pbi-manager-${ver} 2>/dev/null

...
scripts.extra=rm -rf /usr/local/share/lifePreserver/scripts && cp -r scripts /usr/local/share/lifePreserver/ && chmod 755 /usr/local/share/lifePreserver/scripts/setup-ssh-keys.sh
